...
public class OldRequestAdapterOfflin extends RecyclerView.Adapter<OldRequestAdapterOfflin.OldRequestOfflinHolder> {
    ...
    @Override
    public OldRequestOfflinHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(OldRequestOfflinHolder holder, int position) {
    ...
    public class OldRequestOfflinHolder extends RecyclerView.ViewHolder {
        ...
        public OldRequestOfflinHolder(View itemView) {
            super(itemView);
